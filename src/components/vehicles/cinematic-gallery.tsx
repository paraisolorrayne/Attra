    ...
    <>
      ...
      <div className="relative h-[60vh] lg:h-[70vh] w-full bg-background-soft overflow-hidden">
        ...
        <button
          ...
          className="absolute left-4 lg:left-8 top-1/2 -translate-y-1/2 p-3 bg-black/40 hover:bg-black/60 backdrop-blur-sm rounded-full text-white transition-all z-30"
        ...
        <button
          onClick={goToNext}
          className="absolute right-4 lg:right-8 top-1/2 -translate-y-1/2 p-3 bg-black/40 hover:bg-black/60 backdrop-blur-sm rounded-full text-white transition-all z-30"
        ...
        <button
          ...
          className="absolute top-4 right-4 p-3 bg-black/40 hover:bg-black/60 backdrop-blur-sm rounded-full text-white transition-all z-30"
        ...
        {/* Image counter */}
        <div className="absolute bottom-4 left-4 px-4 py-2 bg-black/40 backdrop-blur-sm rounded-full text-white text-sm z-30">
          {currentIndex + 1} / {photos.length}
        </div>

        {/* Thumbnail strip */}
        <div className="absolute bottom-4 left-1/2 -translate-x-1/2 flex gap-2 max-w-[80%] overflow-x-auto py-2 px-4 z-30">
          {photos.map((photo, index) => (
            <button
              key={index}

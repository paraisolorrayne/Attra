    ...
    <div className="relative w-full">
      <div className="relative flex items-center">
        ...
        <input
          ...
          className="w-full bg-background-card border border-border/50 hover:border-border focus:border-primary/40 focus:ring-2 focus:ring-primary/10 rounded-xl pl-12 pr-12 sm:pr-24 py-3.5 text-foreground placeholder:text-foreground-secondary/50 focus:outline-none transition-all text-sm"
        />
        {query && (
          <button
            onClick={() => { setQuery(''); handleSearch('') }}
            className="absolute right-2 sm:right-20 p-1.5 text-foreground-secondary hover:text-foreground transition-colors"
        ...
        <button
          ...
          className="hidden sm:block absolute right-2 bg-primary hover:bg-primary-hover text-white rounded-lg px-4 py-2 text-sm font-medium transition-colors"
        >
          Buscar
        </button>
      </div>

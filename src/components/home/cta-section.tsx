...
const ctaItems = [
  {
    ...
    description: 'Desde 2008 trazendo Ferrari, Lamborghini, Porsche, McLaren e outros ícones para o Brasil.',
  ...
  },
  {
    ...
    description: 'Condições especiais para veículos de alto padrão. Taxas competitivas e agilidade.',
    href: '/financiamento',
  ...
  },
  {
    ...
    description: 'Avaliação especializada e discreta para seu veículo, com pagamento ágil e seguro.',
  ...
  },
  {
    ...
    description: 'Não encontrou o modelo ideal? Nossa equipe busca exatamente o que você procura.',

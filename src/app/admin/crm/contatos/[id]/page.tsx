    ...
    >
      ...
      >
        ...
        <div className="p-6 space-y-6">
          ...
          {/* Status - todas as compras no histórico são vendas concluídas */}
          <div className="flex items-center justify-between p-3 bg-background-soft rounded-lg">
            ...
            <span className={cn(
              ...
              compra.status === 'vendido'
                ...
                : compra.status === 'trocado'
                ? 'bg-blue-100 text-blue-800 dark:bg-blue-900/30 dark:text-blue-400'
                : 'bg-green-100 text-green-800 dark:bg-green-900/30 dark:text-green-400'
            )}>
              {compra.status === 'vendido' ? 'Concluída' :
               compra.status === 'trocado' ? 'Troca' : 'Ativo'}
            </span>
          </div>
        </div>
  ...
  if (error || !cliente) {
    return (
      <div className="flex flex-col items-center justify-center py-24 text-foreground-secondary">
        ...
        <Link href="/admin/crm/contatos" className="mt-4 text-primary hover:underline">
      ...
      <div className="flex items-start justify-between">
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-foreground-secondary">Contato desde {formatDate(cliente.criado_em)}</p>
          </div>
        </div>
      </div>

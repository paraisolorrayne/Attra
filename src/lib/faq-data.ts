...
// Serviços FAQs - Questions about services
export const servicosFAQs: FAQItem[] = [
  {
    question: 'Quais são as taxas de financiamento para veículos de luxo?',
    answer: 'As taxas variam conforme perfil de crédito, valor de entrada e prazo. Fazemos simulação personalizada sem compromisso.',
  },
  {
    question: 'Qual o prazo máximo de financiamento?',
    answer: 'Oprazo varia conforme o banco, geralmente com entrada mínima de 20% do valor do veículo. Quanto maior a entrada, melhores as condições de taxa.',
  },
  {
    question: 'A Attra oferece seguro para veículos de alto valor?',
    answer: 'Sim, trabalhamos com seguradoras especializadas em veículos premium e supercarros. Oferecemos cotação com as melhores seguradoras do mercado, incluindo cobertura para peças importadas.',
  },
  {
    question: 'Vocês fazem consignação de veículos?',
    answer: 'Sim, oferecemos serviço de consignação para veículos premium. Seu carro fica exposto em nossa loja com toda a estrutura de vendas, marketing e atendimento profissional.',
  },
  {
    question: 'Como funciona a blindagem de veículos?',
    answer: 'Trabalhamos com as melhores blindadoras do Brasil, oferecendo blindagem nível III-A para veículos de luxo. O processo leva de 30 a 45 dias e inclui garantia de 5 anos.',
  },
]

...
export const SEO_BRANDS: SEOBrand[] = [
	{
		...
		metaTitle: 'Comprar Porsche no Brasil | Porsche Seminovo e 0 km | Attra Veículos',
		...
		models: [
			{
				...
				metaTitle: 'Porsche 911 à Venda no Brasil | Carrera, Turbo, GT3 | Attra Veículos',
			...
			},
			{
				...
				metaTitle: 'Porsche Cayenne à Venda no Brasil | SUV Premium | Attra Veículos',
			...
			},
			{
				...
				metaTitle: 'Porsche Macan à Venda no Brasil | SUV Esportivo | Attra Veículos',
	...
	},
	{
		...
		metaTitle: 'Comprar Ferrari no Brasil | Ferrari à Venda | Attra Veículos',
		...
		models: [
			{
				...
				metaTitle: 'Ferrari Roma à Venda no Brasil | GT V8 Biturbo | Attra Veículos',
			...
			},
			{
				...
				metaTitle: 'Ferrari SF90 Stradale à Venda | 1.000 cv Híbrido | Attra Veículos',
	...
	},
	{
		...
		metaTitle: 'Comprar BMW no Brasil | BMW Seminovo e 0 km | Attra Veículos',
		...
		models: [
			{
				...
				metaTitle: 'BMW M3 à Venda no Brasil | M3 Competition | Attra Veículos',
			...
			},
			{
				...
				metaTitle: 'BMW X5 à Venda no Brasil | SUV Premium | Attra Veículos',
			...
			},
			{
				...
				metaTitle: 'BMW X6 à Venda no Brasil | SUV Coupé | Attra Veículos',
	...
	},
	{
		...
		metaTitle: 'Comprar Mercedes-Benz no Brasil | Mercedes Seminovo | Attra Veículos',
		...
		models: [
			{
				...
				metaTitle: 'Mercedes-AMG GT à Venda no Brasil | V8 Biturbo | Attra Veículos',
			...
			},
			{
				...
				metaTitle: 'Mercedes G 63 AMG à Venda no Brasil | SUV V8 | Attra Veículos',
	...
	},
	{
		...
		metaTitle: 'Comprar Audi no Brasil | Audi Seminovo e 0 km | Attra Veículos',
		...
		models: [
			{
				...
				metaTitle: 'Audi R8 à Venda no Brasil | V10 Quattro | Attra Veículos',
	...
	},
	{
		...
		metaTitle: 'Comprar Land Rover no Brasil | Range Rover e Defender | Attra Veículos',
		...
		models: [
			{
				...
				metaTitle: 'Range Rover à Venda no Brasil | SUV de Luxo | Attra Veículos',
	...
	},
	{
		...
		metaTitle: 'Comprar Chevrolet Premium no Brasil | Corvette e Camaro | Attra Veículos',
		...
		models: [
			{
				...
				metaTitle: 'Corvette Z06 à Venda no Brasil | V8 670 cv | Attra Veículos',
	...
	},
	{
		...
		metaTitle: 'Comprar McLaren no Brasil | McLaren à Venda | Attra Veículos',
		...
		models: [
			{
				...
				metaTitle: 'McLaren Artura à Venda no Brasil | Híbrido 680 cv | Attra Veículos',
